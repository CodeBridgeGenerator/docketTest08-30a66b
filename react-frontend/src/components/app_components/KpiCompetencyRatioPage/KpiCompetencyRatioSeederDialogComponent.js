...
import seederData from "./kpiCompetencyRatio.seeder.json";
...
const KpiCompetencyRatioSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(KpiCompetencyRatioSeederDialogComponent);
