const { KpiCompetencyRatio } = require("./kpiCompetencyRatio.class");
const createModel = require("./kpiCompetencyRatio.model");
const hooks = require("./kpiCompetencyRatio.hooks");
...
module.exports = function (app) {
  ...
  app.use("/kpiCompetencyRatio", new KpiCompetencyRatio(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("kpiCompetencyRatio");

  // Get the schema of the collections 
  app.get("/kpiCompetencyRatioSchema", function (request, response) {
